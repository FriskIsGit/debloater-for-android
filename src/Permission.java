public enum Permission {
    ...
    ACCESS_COARSE_LOCATION("android.permission.ACCESS_COARSE_LOCATION", "COARSE_LOCATION"),
    ACCESS_FINE_LOCATION("android.permission.ACCESS_FINE_LOCATION", "FINE_LOCATION"),
